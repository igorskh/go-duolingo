...
// WithUserID adds the userID to the get subscriptions params
func (o *GetSubscriptionsParams) WithUserID(userID int64) *GetSubscriptionsParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get subscriptions params
func (o *GetSubscriptionsParams) SetUserID(userID int64) {
	o.UserID = userID
}
