...
// WithFields adds the fields to the get user params
func (o *GetUserParams) WithFields(fields []string) *GetUserParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the get user params
func (o *GetUserParams) SetFields(fields []string) {
	o.Fields = fields
}
