...
func (o *PostLoginParams) WithUsername(username *models.LoginData) *PostLoginParams {
	o.SetUsername(username)
	return o
}

// SetUsername adds the username to the post login params
func (o *PostLoginParams) SetUsername(username *models.LoginData) {
	o.Username = username
}
